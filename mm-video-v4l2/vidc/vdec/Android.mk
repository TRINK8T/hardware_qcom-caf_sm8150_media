...
libmm-vdec-inc          += $(TOP)/hardware/qcom-caf/sm8150/media/mm-video-v4l2/vidc/common/inc
libmm-vdec-inc          += $(TOP)/hardware/qcom-caf/sm8150/media/mm-core/inc
libmm-vdec-inc          += $(TOP)/hardware/qcom-caf/sm8150/media/libplatformconfig
libmm-vdec-inc          += $(TARGET_OUT_HEADERS)/adreno
libmm-vdec-inc      	+= $(TOP)/hardware/qcom-caf/sm8150/media/libc2dcolorconvert
libmm-vdec-inc      	+= $(TARGET_OUT_HEADERS)/mm-video/SwVdec
libmm-vdec-inc      	+= $(TARGET_OUT_HEADERS)/mm-video/swvdec
libmm-vdec-inc      	+= $(TARGET_OUT_INTERMEDIATES)/KERNEL_OBJ/usr/include
libmm-vdec-inc      	+= $(TOP)/hardware/qcom-caf/sm8150/media/libarbitrarybytes/inc

ifeq ($(PLATFORM_SDK_VERSION), 18)  #JB_MR2
libmm-vdec-def += -DANDROID_JELLYBEAN_MR2=1
libmm-vdec-inc += $(TOP)/hardware/qcom-caf/sm8150/media/libstagefrighthw
endif
...
libmm-vdec-inc += $(TOP)/hardware/qcom-caf/sm8150/media/hypv-intercept
endif
# ---------------------------------------------------------------------------------
